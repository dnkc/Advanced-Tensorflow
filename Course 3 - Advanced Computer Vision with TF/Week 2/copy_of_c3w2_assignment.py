# -*- coding: utf-8 -*-
"""Copy of C3W2_Assignment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13tcH5GpRJYFEoV_othCsYyD5pj1MN5yY
...
for i in range(1, 6):
    ...
    image_path = os.path.join('training', 'training-zombie{}'.format(i)+'.jpg')
    print(image_path)
...
# i: 3 	 name: WeightSharedConvolutionalBoxPredictor/WeightSharedConvolutionalClassHead/ClassPredictor/bias:0 	 shape:(546,) 	 dtype=<dtype
