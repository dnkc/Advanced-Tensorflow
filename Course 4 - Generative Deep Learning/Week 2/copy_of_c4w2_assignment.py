...
Original file is located at
    https://colab.research.google.com/drive/160FyS4B3kWO10iCiDq5-PTAgXQpDdnfA
...
### START CODE HERE ###
model.fit(train_dataset, validation_data=test_dataset,steps_per_epoch=train_steps, epochs=75)
### END CODE HERE ###
