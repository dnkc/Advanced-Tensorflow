# -*- coding: utf-8 -*-
"""Copy of C4W3_Assignment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CittXEBKvk7j_WO1od9y-w97a2x7r5lp
...
def encoder_layers(inputs, latent_dim):
  ...
  mu = tf.keras.layers.Dense(latent_dim, name='atent_mu')(x)
  sigma = tf.keras.layers.Dense(latent_dim, name='atent_sigma')(x)
